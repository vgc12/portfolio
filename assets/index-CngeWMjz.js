...
var zaid_abuisba_default = "/portfolio/assets/zaid-abuisba-B1jvLZMV.jpg";
var webgpu_renderer_default = "/portfolio/assets/webgpu-renderer-Bmzrb_ZI.png";
var vandull_default = "/portfolio/assets/vandull-CKNcaWYL.png";
var sword_bound_default = "/portfolio/assets/sword-bound-fuySIZMH.png";
var fours_default = "/portfolio/assets/backup-scheduler-Cgytu5cM.png";
var pan_default = "/portfolio/assets/pan-F0ByIFuL.png";
var backup_scheduler_default = "/portfolio/assets/backup-scheduler-Cgytu5cM.png";
var tutorial_site_default = "/portfolio/assets/tutorial-site-DYl5SEAk.png";
var attendance_tracker_default = "/portfolio/assets/attendance-tracker-ONuGiglx.png";
/**
* @license React
...
var SocialLink = ({ href, icon: Icon$1, label, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
	href,
	"aria-label": label,
	className: `p-3 rounded-full transition-colors ${isDark ? "bg-blue-600 hover:bg-blue-700" : "bg-blue-600 hover:bg-blue-700"}`,
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon$1, { className: "w-6 h-6 text-white" })
});
var ProfileSection = ({ name, title, bio, imageUrl, socialLinks, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	className: "flex flex-col md:flex-row items-center gap-12 mb-20",
	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: `w-64 h-64 rounded-full overflow-hidden border-4 shadow-2xl ${isDark ? "border-blue-400 shadow-blue-500/50" : "border-blue-500 shadow-blue-500/30"}`,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: `text-5xl md:text-6xl font-bold mb-4 ${isDark ? "text-white" : "text-gray-900"}`,
				children: name
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: `text-2xl mb-4 ${isDark ? "text-blue-300" : "text-blue-600"}`,
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: `text-lg mb-6 max-w-2xl ${isDark ? "text-gray-300" : "text-gray-700"}`,
				children: bio
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-4 justify-center md:justify-start",
				children: socialLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SocialLink, {
					href: link.href,
					icon: link.icon,
					label: link.label,
					isDark
...
var Tag = ({ children, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	className: `px-3 py-1 rounded-full text-sm ${isDark ? "bg-blue-600/30 text-blue-200" : "bg-blue-100 text-blue-700"}`,
	children
});
var ProjectCard = ({ project, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	className: `rounded-xl overflow-hidden border transition-all duration-300 hover:transform hover:scale-105 shadow-lg ${isDark ? "bg-slate-800/50 backdrop-blur-sm border-blue-500/30 hover:border-blue-400 hover:shadow-blue-500/50" : "bg-white border-gray-200 hover:border-blue-500 hover:shadow-blue-500/30"}`,
	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: project.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, {
					isDark,
					children: tag
				}, tag))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					className: `flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors ${isDark ? "bg-blue-600 hover:bg-blue-700" : "bg-blue-600 hover:bg-blue-700"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "w-4 h-4" }), "View"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					href: project.githubLink,
					className: `flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors ${isDark ? "bg-slate-700 hover:bg-slate-600" : "bg-gray-700 hover:bg-gray-800"}`,
...
var ProjectsSection = ({ projects, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	className: "mb-12",
	children: [
		"Game",
		"Web",
		"Other"
	].map((type) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mb-8",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
			className: `text-3xl font-semibold mb-6 ${isDark ? "text-white" : "text-gray-900"}`,
			children: [type, " Projects"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8",
			children: projects.filter((project) => project.type === type).map((project) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProjectCard, {
				project,
				isDark
			}, project.id))
		})]
...
var Footer = ({ name, isDark }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	className: `text-center pt-12 border-t ${isDark ? "border-blue-500/30" : "border-gray-300"}`,
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: isDark ? "text-gray-400" : "text-gray-600",
		children: name
	})
});
var GithubIcon = ({ className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	className,
	fill: "currentColor",
	viewBox: "0 0 24 24",
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" })
});
var LinkedinIcon = ({ className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	className,
	fill: "currentColor",
	viewBox: "0 0 24 24",
...
function Portfolio() {
	...
	const profileData = {
		...
		imageUrl: zaid_abuisba_default,
		socialLinks: [
			{
				href: "https://github.com/vgc12",
				icon: GithubIcon,
				label: "GitHub"
			},
			{
				href: "https://www.linkedin.com/in/zaid-abuisba-ab088826a/",
				icon: LinkedinIcon,
				label: "LinkedIn"
			},
			{
				href: "mailto:zaidabuisba@gmail.com",
				icon: Mail,
				label: "Email"
			}
		]
	};
	const [projects] = (0, import_react.useState)([
		{
			id: 1,
			title: "WebGPU 3D Renderer",
			type: "Web",
			description: "Developed a real-time 3D renderer in React and WebGPU...",
			image: webgpu_renderer_default,
			tags: [
				"WebGPU",
		...
		},
		{
			...
			image: backup_scheduler_default,
			tags: [
				"C#",
				"CLI",
				"File Management"
		...
		},
		{
			...
			image: attendance_tracker_default,
			tags: [
				"C#",
				"ASP.NET",
				"Entity Framework",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: `min-h-screen font-['Inter',sans-serif] transition-colors duration-300 ${isDark ? "bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900" : "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50"}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "fixed top-6 right-6 z-50",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				onClick: () => setIsDark(!isDark),
				className: `p-3 rounded-full shadow-lg transition-all ${isDark ? "bg-slate-800 hover:bg-slate-700 text-yellow-400" : "bg-white hover:bg-gray-100 text-indigo-600"}`,
				"aria-label": "Toggle dark mode",
				children: isDark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "w-6 h-6" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "w-6 h-6" })
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
(0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portfolio, {}) }));
